...
import { StyleSheet, Text, View, ScrollView, TouchableOpacity, Linking,
Platform, Alert, AsyncStorage } from 'react-native';
...
export default class ViewContactScreen extends React.Component {
  ...
  //use async dont want may thread to be busy write async
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.contactIconContainer}>
        <Text style={styles.contactIcon}>{this.state.fname[0].toUpperCase()}</Text></View>
