...
// async makes the code run asynchronously
  playSound = nasync umber => {
    cont soundObject = new Audio.Sound();
    try {
      ...
      .then( async playbackStatus => {
        ...
        }, playbackStatus.playableDurationMillis); //getting exact duration of sound
      })
      .catch(error => {
        console.log(error)
      })
